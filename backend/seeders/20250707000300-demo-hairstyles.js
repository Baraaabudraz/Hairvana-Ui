    ...
    await queryInterface.bulkInsert('hairstyles', [
      {
        ...
        segmented_image_url: 'https://example.com/bob-segmented.jpg',
        ar_model_url: null,
        gender: 'female',
        length: 'short',
        color: 'brown',
      ...
      },
      {
        ...
        segmented_image_url: 'https://example.com/pompadour-segmented.jpg',
        ar_model_url: null,
        gender: 'male',
        length: 'medium',
        color: 'black',
      ...
      },
      {
        ...
        segmented_image_url: 'https://example.com/layered-segmented.jpg',
        ar_model_url: null,
        gender: 'female',
        length: 'medium',
        color: 'blonde',
      ...
      },
      {
        ...
        segmented_image_url: 'https://example.com/buzz-segmented.jpg',
        ar_model_url: null,
        gender: 'male',
        length: 'short',
        color: 'black',
