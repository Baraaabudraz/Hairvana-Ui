...
export async function fetchReports() {
  return apiFetch('/backend/api/reports');
}
...
export async function updateReport(id: string, data: any) {
  return apiFetch(`/backend/api/reports/${id}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  });
}
...
export async function fetchReportTemplates() {
  return apiFetch('/backend/api/report-templates');
}
...
export async function updateReportTemplate(id: string, data: any) {
  return apiFetch(`/backend/api/report-templates/${id}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  });
}
