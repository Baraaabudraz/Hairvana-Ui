...
const SubscriptionsPage = lazy(() => import('./pages/dashboard/subscriptions/index'));
const SubscriptionDetailsPage = lazy(() => import('./pages/dashboard/subscriptions/details'));
const NewSubscriptionPage = lazy(() => import('./pages/dashboard/subscriptions/new'));
  ...
  return (
    <Routes>
      ...
      <Route path="/dashboard" element={<DashboardLayout />}>
        ...
        <Route path="salons/:id/edit" element={
          <Suspense fallback={<PageLoader />}>
            <EditSalonPage />
          </Suspense>
        } />
        <Route path="salons/new" element={
          <Suspense fallback={<PageLoader />}>
            <NewSalonPage />
          </Suspense>
        } />
